...
module.exports = {
  ...
  controller: function ($scope) {
    ...
    ctrl.$onChanges = function () {
      var index  = ctrl.nodeIndex;
      $scope.model = ctrl.model;
      $scope.nodeIndex = ctrl.nodeIndex;
      $scope.nodeStatus = ctrl.model[index];
      $scope.name = 'application';

      console.info("onChanges---------"+index);
      console.info($scope);
    };
  },
  template: '<ng-include src="\'nbone/views/templates/nbone-status.html\'"></ng-include>'
};
